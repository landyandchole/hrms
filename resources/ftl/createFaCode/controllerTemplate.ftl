package com.hand.controller.${packageName}.${objectNameLower};
...
import com.hand.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.hand.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
