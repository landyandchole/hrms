package com.hand.controller.system.head;
...
import com.hand.service.system.fhsms.FhsmsManager;
...
import com.hand.util.SmsUtil;
import com.hand.util.Tools;
import com.hand.util.Watermark;
...
public class HeadController extends BaseController {
	...
	public ModelAndView goEmail() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		StringBuffer sb = new StringBuffer();
		String nos = pd.getString("NO");
		 ...
		 Set set = new TreeSet();
	        ...
	        for(String str1: str){
	        	pd.put("NO", str1);
	        	pd=	staffService.findByNo(pd);
	        	sb.append(pd.getString("EMAIL"));
	        	sb.append(";");
	        }
	    pd.put("EMAIL", sb);    
		mv.setViewName("system/head/send_email");
