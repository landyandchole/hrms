package com.hand.controller.system.dictionaries;
...
public class DictionariesController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		FHLOG.save(Jurisdiction.getUsername(), "新增数据字典","SYS_DICTIONARIES","NAME",pd.getString("NAME"));
	...
	public Object delete(@RequestParam String DICTIONARIES_ID) throws Exception{
		...
		if("success".equals(errInfo)){
			...
			FHLOG.save(Jurisdiction.getUsername(), "删除数据字典","SYS_DICTIONARIES","DICTIONARIES_ID",pd.getString("DICTIONARIES_ID"));
		}
	...
	public ModelAndView edit() throws Exception{
		...
		FHLOG.save(Jurisdiction.getUsername(), "修改数据字典","SYS_DICTIONARIES","DICTIONARIES_ID",pd.getString("DICTIONARIES_ID"));
		mv.addObject("msg","success");
		mv.setViewName("save_result");
		return mv;
	}
