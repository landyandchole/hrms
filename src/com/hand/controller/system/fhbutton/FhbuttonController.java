package com.hand.controller.system.fhbutton;
...
public class FhbuttonController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		FHLOG.save(Jurisdiction.getUsername(), "新增按钮","SYS_FHBUTTON","NAME",pd.getString("NAME"));
	...
	public void delete(PrintWriter out) throws Exception{
		...
		FHLOG.save(Jurisdiction.getUsername(), "删除按钮","SYS_FHBUTTON","FHBUTTON_ID",pd.getString("FHBUTTON_ID"));
		out.write("success");
		out.close();
	}
	...
	public ModelAndView edit() throws Exception{
		...
		FHLOG.save(Jurisdiction.getUsername(), "修改按钮","SYS_FHBUTTON","NAME",pd.getString("NAME"));
		mv.addObject("msg","success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public Object deleteAll() throws Exception{
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			FHLOG.save(Jurisdiction.getUsername(), "批量删除按钮","SYS_FHBUTTON","FHBUTTON_ID",DATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
