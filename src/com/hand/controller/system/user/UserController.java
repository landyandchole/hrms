package com.hand.controller.system.user;
...
public class UserController extends BaseController {
	...
	public ModelAndView listUsers(Page page)throws Exception{
		...
		pd.put("PARENT_ID", "1");
		List<Role> roleList = roleService.listAllRolesByPaId(pd);//列出所有系统用户角色
	...
	public void deleteU(PrintWriter out) throws Exception{
		...
		FHLOG.save(Jurisdiction.getUsername(), "删除系统用户："+pd,"SYS_USER","USER_ID",pd.getString("USER_ID"));
		out.write("success");
		out.close();
	}
	...
	public ModelAndView saveU() throws Exception{
		...
		if(null == userService.findByUsername(pd)){	//判断用户名是否存在
			...
			FHLOG.save(Jurisdiction.getUsername(), "新增系统用户："+pd.getString("USERNAME"),"SYS_USER","USER_ID",pd.getString("USER_ID"));
	...
	public ModelAndView goEditMyU() throws Exception{
		...
		pd1 = userService.findByUsername(pd);						//根据用户名读取
		if(pd1 == null){
	...
	public ModelAndView editU(HttpServletRequest request) throws Exception{
		...
		appuserService.updateM(pd);	//执行修改
		FHLOG.save(Jurisdiction.getUsername(), "修改普通用户："+pd.getString("USERNAME"),"SYS_USER","USER_ID",pd.getString("USER_ID"));
...
//		session.removeAttribute(Const.SESSION_USERROL);
	...
	public Object deleteAllU() throws Exception {
		...
		FHLOG.save(Jurisdiction.getUsername(), "批量删除user","SYS_USER","USER_ID",USER_IDS);
		pdList.add(pd);
		map.put("list", pdList);
	...
	public ModelAndView readExcel(
		...
		FHLOG.save(Jurisdiction.getUsername(), "从EXCEL导入到数据库","SYS_USER","","");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
