		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="fittings/goList.do" method="post" name="Form" id="Form">
										...
										<tr>
											...
											<c:if test="${QX.edit != 1 && QX.del != 1 }">
												...
												<div class="hidden-sm hidden-xs btn-group">	
													...
													<c:if test="${QX.edit == 1 }">
														<a class="btn btn-xs btn-success" title="编辑" onclick="edit('${var.FITTINGS_ID}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															...
															<li>
																<a style="cursor:pointer;" onclick="edit('${var.FITTINGS_ID}');" class="tooltip-success" data-rel="tooltip" title="修改">
																	<span class="green">
						 ...
						 <table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									<c:if test="${QX.add == 1 }">
									<a class="btn btn-mini btn-success" onclick="add('${pd.PARENT_ID}');">新增</a>
									</c:if>
									<%-- <c:if test="${QX.del == 1 }">
