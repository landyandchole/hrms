	...
	<div class="main-content">
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
					<form action="fittingsmanager/save.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="FITTINGS_ID" id="FITTINGS_ID" value="${pd.FITTINGS_ID}"  data-placeholder="请选择配件" style="vertical-align:top;width: 120px";onchange="fittingType();">
