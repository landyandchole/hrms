...
<body class="no-skin">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">事件发起人</th>
									<th class="center">备注</th>
									<th class="center">事件发起日期</th>
									<th class="center">事件截至日期</th>
									<th class="center">上传文件名</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr >
											...
											<td class='center'>${var.EVENT_PERSON}</td>
											<td class='center'>${var.EVENT_BS}</td>
											<td class='center'>${var.EVENT_DDATE}</td>
											<td class='center'>${var.EVENT_DATE}</td>
											<td class='center'>${var.EVENT_FILE}</td>
											...
											<td style="width:180px; padding-left:50px;">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<c:if test="${QX.edit == 1 && null != var.EVENT_FILE}">
													<a class="btn btn-light btn-xs" title="下载" onclick="my_download('${var.EVENT_ID}');">
														<i class="ace-icon fa fa-download bigger-110 nav-search-icon blue" title="下载"></i>
													</a>
													</c:if>
													...
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															...
															<li>
															 ...
															 <c:if test="${QX.edit == 1 }">
															<li>
																<a style="cursor:pointer;" href="<%=basePath%>event/download.do?EVENT_ID=${var.EVENT_ID}" target="hidden_frame"  class="tooltip-download" data-rel="tooltip" title="下载">
																	<span class="blue">
																		<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																	</span>
																</a>
	...
	<script type="text/javascript">
       ...
       function my_download(Id){
			
			var url = "<%=basePath%>event/download.do?EVENT_ID="+Id+"&tm="+new Date().getTime();
