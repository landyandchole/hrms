		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="event/save.do" name="Form" id="Form" method="post"enctype="multipart/form-data">
						<input type="hidden" name="EVENT_ID" id="EVENT_ID" value="${pd.EVENT_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:105px;text-align: right;padding-top: 13px;">事件名称:</td>
						...
						<tr>
							...
							<tr>
								...
								<td><input type="text" name="EVENT_BS" id="EVENT_BS" value="${pd.EVENT_BS}" maxlength="255" placeholder="这里输入备注" title="备注" style="width:98%;"/></td>
							</tr>
							<tr>
