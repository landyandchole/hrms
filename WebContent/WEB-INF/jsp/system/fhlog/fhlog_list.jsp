								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center' style="width: 100px;">${var.TABLENAME}</td>
											<td class='center' style="width: 100px;">${var.CZTIME}</td>
											<td class='center' style="width: 100px;">${var.COLUMNNAME}</td>
											<td class='center' style="width: 100px;">${var.LOGO}</td>
