...
<body>
	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		...
		<div id="loginbox" >
				...
				<div style="float:right;padding-right:10%;">
					<div style="float: left;">
						<input name="form-field-checkbox" id="saveid" type="checkbox"
							onclick="savePaw();" style="padding-top:4px;" />
					</div>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © 上海汉得信息技术股份有限公司</span></font>
				</div>
			</div>
		</div>
		</div>
	...
	<div id="templatemo_banner_slide" class="container_wapper">
		<div class="camera_wrap camera_emboss" id="camera_slide">
			...
			<c:choose>
				...
				<c:otherwise>
					<div data-src="static/login/images/1.jpg"></div>
					<div data-src="static/login/images/2.jpg"></div>
					<!-- <div data-src="static/login/images/3.jpg"></div> -->
					<div data-src="static/login/images/4.jpg"></div>
					<!-- <div data-src="static/login/images/banner_slide_02.jpg"></div> -->
					<!-- <div data-src="static/login/images/03.jpg"></div>
					<div data-src="static/login/images/04.jpg"></div>
					<div data-src="static/login/images/5.jpg"></div> -->
				</c:otherwise>
			</c:choose>
