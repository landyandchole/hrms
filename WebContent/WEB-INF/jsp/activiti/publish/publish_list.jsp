...
<body class="no-skin">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">流程编号</th>
									<th class="center">流程名称</th>
									<th class="center">部署日期</th>
								</tr>
							</thead>
						<tbody>
							<!-- 开始循环 -->	
								...
								<c:when test="${not empty varList}">
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'><fmt:formatDate  value="${var.deploymentTime}" type="both" pattern="yyyy-MM-dd HH:mm:ss" /></td>
										</tr>
									</c:forEach>
								</c:when>
								<c:otherwise>
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>publish/goAdd.do';
			 diag.Width = 450;
			 diag.Height = 355;
